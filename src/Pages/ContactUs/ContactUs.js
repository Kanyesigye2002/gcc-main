                        ...
                        <form onSubmit={onSubmit} className={classes.root} noValidate autoComplete="off">
                            <Grid spacing={5} container direction="row" justify="center" alignItems="center">
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Controls.Input type="name" name="firstName" label="First Name" value={names1} onChange={name1}/>
                                </Grid>
                                <Grid item xs={12} sm={6}>
                                    <Controls.Input type="name" name="lastName" label="Last Name" value={names2} onChange={name2}/>
                                </Grid>
                                <Grid item xs={12}>
                                    <Controls.Input type="email" name="email" label="Email" value={data.email} onChange={onChange}/>
                                </Grid>
                                <Grid item xs={12}>
